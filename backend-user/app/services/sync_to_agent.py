        ...
        try:
            r = await client.post(
                ...
                json={
                    ...
                    "total_bets": player.total_bets or 0,
                    "total_amount": float(player.total_amount or 0),
                    "win_amount": float(player.win_amount or 0),
                    "loss_amount": float(player.loss_amount or 0),
